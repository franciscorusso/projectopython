...
doc = """\
    Groups the lines of a file into runs of characters.

    Usage: pycoder.py (-c [-t TYPE] | -d) [-p PASSWD] FILE

    Options:
    -c, --encode            Encode a file.
    -d, --decode            Decode a file.
    -t, --type=TYPE         Type of compression. [default: 2]
    -p, --password=PASSWD   Password for encryption/decryption. [default: none]
    """
